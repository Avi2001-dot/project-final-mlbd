...
class TestKaggleDataIngestionInit:
    """Tests for KaggleDataIngestion initialization."""
    ...
    def test_init_with_missing_api_key(self):
        ...
        with pytest.raises(FileNotFoundError):
            KaggleDataIngestion(
                api_key_path='/nonexistent/path/kaggle.json',
...
class TestSchemaValidation:
    ...
    def setup_method(self):
        ...
        # Patch KaggleApi before importing KaggleDataIngestion
        ...
        from src.data_ingestion.kaggle_ingestion import KaggleDataIngestion
        self.KaggleDataIngestion = KaggleDataIngestion
        
        self.ingestion = KaggleDataIngestion(
...
class TestErrorHandling:
    ...
    def setup_method(self):
        ...
        from src.data_ingestion.kaggle_ingestion import (
            KaggleDataIngestion,
            KaggleConnectionError
        )
        self.KaggleDataIngestion = KaggleDataIngestion
        self.KaggleConnectionError = KaggleConnectionError
    ...
    def test_kaggle_connection_error_message(self):
        """Test KaggleConnectionError has proper message."""
        error = self.KaggleConnectionError("Test error message")
    ...
    def test_download_dataset_api_error(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with pytest.raises(self.KaggleConnectionError):
                self.ingestion._download_dataset(temp_dir)
