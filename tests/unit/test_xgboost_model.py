...
def test_xgboost_initialization_with_custom_params():
    """Test XGBoostModel initialization with custom hyperparameters."""
    custom_params = {
        'max_depth': 8,
        'learning_rate': 0.05,
        'n_estimators': 50
    ...
    model = XGBoostModel(hyperparameters=custom_params)
...
def test_xgboost_train_without_cv(sample_data):
...
def test_xgboost_train_with_cv(sample_data):
...
def test_xgboost_train_invalid_input(sample_data):
...
def test_xgboost_predict(sample_data):
    """Test prediction."""
    X, y = sample_data
    model = XGBoostModel()
...
def test_xgboost_predict_24h(sample_data):
...
def test_xgboost_feature_importance_top_n(sample_data):
...
def test_xgboost_evaluate(sample_data):
...
def test_xgboost_get_model_info(sample_data):
